...
<FORM ACTION='edi_traffic_view_tp.php' NAME=\"webedi_reports\" METHOD=\"POST\" xONCLICK=\"document.forms.webedi_reports.form_submit.disabled=true;\">
    <HR><?php
#	MS SQL
$ms_db_host = "win-sql4.datatrans-inc.com";
$ms_db_user = "edi_reports";
$ms_db_pass = "3d1_r3p0r75";
$ms_db_name = "AS2A";
...
if ($_REQUEST["form_submit"] == "Submit" || $updating || $userid <> '') {
    ...
    if (true) { // $tpid!='')
       ...
       /* $dtlTemplate->set_file('as2d', 'detailview.tpl');
        $dtlTemplate->set_var(array("NAME" => "WinProd 2", "DB" => "AS2D", "QSTRING" => $_SERVER['QUERY_STRING']));
