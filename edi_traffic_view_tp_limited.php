...
print "<FONT STYLE='font-family:verdana;font-size:20;font-weight:bold'>Billing Detail for {$partner["company_name"]}<br>Month: $month/$year</FONT><BR>";
print "<HR>";
...
include_once("edi_traffic_queries.php");
